      ...
      child: Row(
        ...
        children: <Widget>[
          IconButton(
            ...
            icon: Icon(Icons.info,size: 30,color: infoColor,), onPressed: (){
            setState(() {
          ...
          IconButton(
            ...
            icon: Icon(Icons.home,size: 30,color: homeColor,), onPressed: (){
            setState(() {
          ...
          IconButton(
            ...
            highlightColor: Colors.transparent,
            icon: Icon(Icons.slow_motion_video,size: 30,color: statisticColor,), onPressed: (){
               setState(() {
              infoColor = Color(0xff727272);
              homeColor = Color(0xff727272)  ;
